# v1.0.12
- Changed the generated `docs/brew_install.md` footer to use a short
  left-aligned `<hr width="200" align="left">` instead of a full-width
  rule, and reordered the footer notes so the "auto-generated by
  go-xbuild-go" line appears before the note about the formula being
  written to the project's own `Formula/` directory
