...
- [Features](#features)
- [Synopsis](#synopsis)
- [Latest Version (v1.0.11)](#latest-version-v1011)
...
The current version is v1.0.11
...
<sub>Brew install instructions and formula automatically generated by [go-xbuild-go](https://github.com/muquit/go-xbuild-go) v1.0.11 on Aug-25-2026</sub>
