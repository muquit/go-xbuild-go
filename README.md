...
- [Features](#features)
- [Synopsis](#synopsis)
- [Latest Version (v1.0.12)](#latest-version-v1012)
...
Options:
  ...
  -brew-extra-bin-files string
    	Comma-separated list of extra files to install into bin (e.g., 'foo.sh,other-tool')
  -build-args string
...
The current version is v1.0.12
...
---
<sub>TOC/glossary expansion by https://github.com/muquit/markdown-toc-go v1.0.6 on Aug-25-2026</sub>
